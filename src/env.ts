export interface Env {
  ...
  // Lodgify booking poller (30-min cron). The account's own API key does register
  // webhooks, but a verified delivery only triggers this same pass for that
  // account, so the poll is what bills either way.
