...
import { Hotel, Building2, Loader2, Check, AlertTriangle, ChevronRight, Settings2, Zap, Info, ShieldCheck, Copy, CreditCard, CheckCheck } from "lucide-react";
    ...
    const handleSubscribe = async (plan: "monthly" | "annual") => {
        ...
        try {
            const r = await fetch("/api/billing/checkout", {
                ...
                body: JSON.stringify({ plan, source: "lodgify-moloni" }),
            });
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="rounded-2xl p-5 flex flex-col gap-4 border border-hairline bg-surface-2/30">
                                    <div>
                                        ...
                                        <p className="text-2xl font-medium tracking-tight">{tB("monthlyPrice")}</p>
                                    </div>
                                ...
                                <div className="rounded-2xl p-5 flex flex-col gap-4 border border-accent/30 bg-[rgba(2,141,196,0.04)]">
                                    <div>
                                        ...
                                        <p className="text-2xl font-medium tracking-tight">{tB("annualPrice")}</p>
                                    </div>
