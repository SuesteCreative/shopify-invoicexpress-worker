export interface Env {
  ...
  // Lodgify booking poller (30-min cron): the one place Lodgify bookings are
  // billed. Webhooks register with the account's own API key, but a verified
  // delivery is only acknowledged.
